...
module Umrdr
  ...
  module MetadataHelper2
      ...
      if out.nil?
        ...
        if export_files
          collection.member_objects.each do |work|
            next unless work.is_a? GenericWork
    ...
    def self.yaml_populate_work( curation_concern:,
      ...
      dir = Pathname.new dir unless dir.is_a? Pathname
      if out.nil?
        curation_concern = GenericWork.find curation_concern if curation_concern.is_a? String
