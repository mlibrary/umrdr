# This is a workaround for a "Missing id" error due to ActionController::Parameters no longer
# being a Hash in later Rails. (fix on line 8 with respond_to?(:permitted?))
# Remove this when Hyrax 2 is on the go.
