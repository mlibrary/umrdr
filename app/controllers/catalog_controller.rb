class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field solr_name("subject", :stored_searchable), label: "Discipline"
    config.add_show_field solr_name("tag", :stored_searchable), label: "Keywords"
    ...
    config.add_show_field solr_name("date_coverage_from", :stored_searchable), label: "Date Coverage Start"
    config.add_show_field solr_name("date_coverage_to", :stored_searchable), label: "Date Coverage End"
