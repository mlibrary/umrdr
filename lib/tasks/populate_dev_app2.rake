...
namespace :deepblue do
  ...
  desc "v2 of Append files to existing collections."
  ...
  desc "v2 of Build app with  collections, works, and files."
  ...
  desc "v2 of Set up demo content"
  ...
  desc "v2 of Migrate collections and works."
  ...
  desc "v2 of Populate app with collections, works, and files."
...
def content_append( path_to_yaml_file:, ingester: nil, options: {}, args: )
  ...
  AppendContentService2.call( path_to_yaml_file: path_to_yaml_file,
                             ingester: ingester,
...
def content_build( path_to_yaml_file:, ingester: nil, options: {}, args: )
  return unless valid_path_to_yaml_file? path_to_yaml_file
  BuildContentService2.call( path_to_yaml_file: path_to_yaml_file,
                            ingester: ingester,
...
def content_populate_users( path_to_yaml_file:, ingester: nil, options:, args: )
  return unless valid_path_to_yaml_file? path_to_yaml_file
  IngestUsersService2.call( path_to_yaml_file: path_to_yaml_file,
                           ingester: ingester,
                           options: options,
                           args: args )
end
