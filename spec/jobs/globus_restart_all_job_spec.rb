...
describe GlobusRestartAllJob do
  ...
  let( :job_complete_file ) { "#{globus_prep_dir}/.test.restarted.#{target_name}" }
  ...
  describe "#perform" do
    context "when can acquire lock" do
      ...
      let( :files ) { [globus_era_file,file00,dir00,dir00tmp,file01,dir01,dir01tmp,file02,file03,dir04,dir05tmp]  }
      let( :id03 ) { "id003" }
