...
test_for({:date_coverage_1_year=>"2000", :date_coverage_1_month=>"02" , :date_coverage_1_day=>"2" , :date_coverage_2_year=>"2001"}, "2000-02-02 TO 2001-01-01")
test_for({:date_coverage_1_year=>"2000", :date_coverage_1_month=>"02" , :date_coverage_1_day=>"2" , :date_coverage_2_year=>"2001", :date_coverage_2_month=>"2"}, "2000-02-02 TO 2001-02-01")
test_for({:date_coverage_1_year=>"2000", :date_coverage_1_month=>"02" , :date_coverage_1_day=>"2" , :date_coverage_2_year=>"2001", :date_coverage_2_month=>"2", :date_coverage_2_day=>"2"}, "2000-02-02 TO 2001-02-02")
end 	